...
class Operators
{
    ...
    const IS_EMPTY_FOR_CURRENCY = 'EMPTY ON ONE CURRENCY';
    const IS_EMPTY_ON_ALL_CURRENCIES = 'EMPTY ON ALL CURRENCY';
    const IS_NOT_EMPTY_FOR_CURRENCY = 'NOT EMPTY ON ONE CURRENCY';
    const IS_NOT_EMPTY_ON_AT_LEAST_ONE_CURRENCY = 'NOT EMPTY ON ALL CURRENCY';
}
