...
/**
 * Check if a product value is complete or not. This checker should be registered as the last one so that
 * other particular checker (metric, prices etc..) can be called before.
 *
 * This way we provide a simple way to check if a custom attribute type is complete or not.
